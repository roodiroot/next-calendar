...
import { Task } from "@/components/calendar/month/month-calendar-block";
import TimeLine from "@/components/calendar/week//time-line";
import TaskCloud from "./task-cloud";
...
const WeekCalendar = ({ tasks, offset }: { tasks: Task[]; offset: number }) => {
  return (
    <div className=" isolate flex lex-1 flex-col overflow-auto bg-white ">
      <div
        ...
        style={{ width: "165%" }}
      >
        <div className="sticky top-0 z-30 flex-none bg-white shadow-sm border-b sm:pr-8">
              ...
              ({ date, today, dayName }, index) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div
                      className={cn(
                        "font-medium ml-1.5  text-gray-900 h-8 w-8 flex items-center justify-center rounded-full",
        ...
        <div className="flex flex-auto">
          <div className="sticky left-0 z-10 w-14 flex-none bg-white border-r border-gray-100"></div>
          <div className="grid flex-auto grid-cols-1 grid-rows-1">
            <div
              className="col-start-1 col-end-2 row-start-1 grid"
              style={{ gridTemplateRows: "repeat(48, minmax(3.5rem, 1fr))" }}
            >
              <div className="row-end-1 h-7 border-b border-gray-100"></div>
              {timeLine.map((i) => (
